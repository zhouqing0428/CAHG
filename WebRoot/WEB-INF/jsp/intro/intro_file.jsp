 ...
 <div id="main">
    ...
    <div class="cen-div color mar-t">
      <div class="con_title_left fl_left">
		...
		<a href='index/page.do'  target="_parent">首页</a>&nbsp;>&nbsp;工作亮点
		</div>   
      </div>
      <div class="cen-div-1 mar-t">
        <div class="con-left fl" style="width:170px;min-height:120px;border:1px solid;">
        	<ul>
	        		...
	        		<li style="padding-right:10px;padding-left:10px;margin-top:15px;">
		                	<a style="color: #fff;background: #2b67ac; color: #fff !important" href="cahgIntro/toIntroPage2.do"  target="_parent" title='工作亮点' ><span style="margin-left:20px;">工作亮点</span></a>
		             </li>
