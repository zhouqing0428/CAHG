 ...
 <div id="main">
    ...
    <div class="cen-div color mar-t">
      <div class="con_title_left fl_left">
		...
		<a href='index/page.do'  target="_parent">首页</a>&nbsp;>&nbsp;海关新闻列表
		</div>   
      </div>
...
getHeader();
	...
	$('.page').createPage(function(curPage){
		$.ajax({
		    url:"cahgCustomNews/customNewsList.do",
		    dataType : "json", 
		    method:"post",
		    async: true,  
		    	...
		    	var html = "";
		     	for(var i=0;i<data.list.length;i++){
		    		html += "<div class='list_div mar-top2 '>" +
		    				"<a href='cahgCustomNews/customNewsDetailsShow.do?custom_news_id="+data.list[i].custom_news_id+"' target='_blank'  >"+
