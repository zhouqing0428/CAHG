...
<a href='index/page.do'  target="_parent">首页</a>&nbsp;>&nbsp;<a href='leaderSpeech/leaderSpeechListPage.do'  target="_parent">领导讲话列表</a>&nbsp;>&nbsp;<a href=''  target="_parent">领导讲话</a>
</div></div>
      ...
      <div class="line mar-t2 hov">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="padding-left:10px; padding-right:10px;color:#666666;">
          <tr>
            <td align="center" width="100%"><b>所属：${newMap.type}&nbsp;&nbsp;&nbsp;发表时间：${newMap.create_date }&nbsp;&nbsp;&nbsp;</b></td>
          </tr>
          
          <tr>
          	<c:if test="${newMap.file_name ne null and newMap.file_name ne ''}">
          		<td align="center" style="height:50px;"><a href="http://10.56.65.100/file/upImg/file/${newMap.file_name}">${newMap.file_old_name }</a>&nbsp;&nbsp;&nbsp;<a href="http://10.56.65.100/file/upImg/file/${newMap.file_name}" target="_blank">【下载】</a></td>
          	</c:if>
           </tr>
