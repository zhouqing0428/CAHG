 ...
 <div id="main">
    ...
    <div class="cen-div color mar-t">
      <div class="con_title_left fl_left">
		...
		<a href='index/page.do'  target="_parent">首页</a>&nbsp;>&nbsp;领导讲话列表
		</div>   
      </div>
...
<script>
	...
	$('.page').createPage(function(curPage){
		$.ajax({
		    url:"leaderSpeech/leaderSpeechList.do",
		    dataType : "json", 
		    method:"post",
		    async: true,  
		    data: {curPage:curPage,title:encodeURI(title, "UTF-8"),type:type},
		    success:function(data){
		    	var html = "";
		     	for(var i=0;i<data.list.length;i++){
		    		html += "<div class='list_div mar-top2 '>" +
		    				"<a href='leaderSpeech/leaderSpeechDetailsPage.do?leader_speech_id="+data.list[i].leader_speech_id+"' target='_blank'  >"+
		    				...
		    				"<td width='50%' align='right' ><span class='column-name'><b>所属："+data.list[i].type+"</b></span></td>"+
		    				"</tr></table></a></div>";
		    	}
		     	$("#list").html(html);
		    }
