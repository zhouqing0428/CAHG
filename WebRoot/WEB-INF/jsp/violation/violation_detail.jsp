      ...
      <div class="con_title_left_c fl_left"> 
      	<div class="fl">
      		<div class="font2 dgrey">
				...
				<a href='cahgViolation/violationListPage.do' target="_parent">违纪曝光列表</a>&nbsp;>&nbsp;<a href='' target="_parent">违纪曝光</a>
			</div>
		</div>
      </div>
      ...
      <div class="line mar-t2 hov">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="padding-left:10px; padding-right:10px;color:#666666;">
          ...
          <c:if test="${info.file_name ne null and info.file_name ne ''}">          <tr>
          	<td align="center" width="100%"><b><a style="color:blue;" href="http://10.56.65.100/file/upImg/cahgViolation/${info.file_name }">【${info.file_old_name}】下载</a></b></td>
          </tr>
         </c:if>
