 ...
 <div id="main">
    ...
    <div class="cen-div color mar-t">
      <div class="con_title_left fl_left">
		...
		<a href='index/page.do'  target="_parent">首页</a>&nbsp;>&nbsp;专题专栏列表
		</div>   
      </div>
      <div class="cen-div-1 mar-t">
        <%-- <iframe class="con-left fl" frameborder="0" scrolling="no" src="index/special_left.do?url=${url}" widht="100%"></iframe> --%>
        ...
        <div class="con-right fr mar-l-2" style="width:740px;">
 			<div id="list">
 			</div>
...
function getSlideMenu(){
	var url = "${url}"
	$.ajax({
	    url:"index/special_left.do?url="+url,
	    dataType : "html", 
	    method:"post",
	    async: true,  
	    data: {},
	...
	$('.page').createPage(function(curPage){
		$.ajax({
		    url:"cahgSpecialTopic/specialTopicList.do",
		    dataType : "json", 
		    method:"post",
		    async: true,  
		    	...
		    	var html = "";
		     	for(var i=0;i<data.list.length;i++){
		    		html += "<div class='list_div mar-top2 '>" +
		    				"<a href='cahgSpecialTopic/specialTopicDetailsPage.do?special_topic_id="+data.list[i].special_topic_id+"' target='_blank'  >"+
