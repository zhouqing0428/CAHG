...
<a href='index/page.do'  target="_parent">首页</a>&nbsp;>&nbsp;<a href='cahgSpecialTopic/specialTopicListPage.do?url=${newMap.special_topic_category_id }'  target="_parent">${newMap.category_name}列表</a>&nbsp;>&nbsp;<a href=''  target="_parent">${newMap.category_name }</a>
      ...
      <div class="line mar-t2 hov">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="padding-left:10px; padding-right:10px;color:#666666;">
          ...
          <c:if test="${newMap.file_name ne null and newMap.file_name ne ''}">          <tr>
          	<td align="center" width="100%"><b><a style="color:blue;" href="http://10.56.65.100/file/upImg/specialtopic/${newMap.file_name }">【${newMap.file_old_name}】下载</a></b></td>
          </tr>
         </c:if>
		<tr style="height:50px;">
          ...
          <%-- <tr>
          	<td align="center" style="height:50px;"><a href="">${newMap.file_old_name }</a>&nbsp;&nbsp;&nbsp;<a href="http://192.168.1.11:8080/CAHGAdmin/upImg/file/${newMap.file_old_name}" target="_blank">【下载】</a></td>
          </tr> --%>
        </table>
      </div>
