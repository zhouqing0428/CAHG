...
<link href="static/css/index_6.css" rel="stylesheet" type="text/css" />
 <div id="main">
    ...
    <div class="cen-div color mar-t">
      ...
      <iframe class="con-left fl" frameborder="0" scrolling="no" src="index/work_left.do?url=${work_table_category_id}" widht="100%"></iframe> 
...
<script>
	...
	var count = '${count}';
	var work_table_category_id = '${work_table_category_id}';
	$('.page').createPage(function(curPage){
		$.ajax({
		    url:"cahgWorkTable/workTableList.do",
		    dataType : "json", 
		    method:"post",
		    async: true,  
		    data: {curPage:curPage,work_table_category_id:work_table_category_id},
		    success:function(data){
		    	var html = "";
		     	for(var i=0;i<data.list.length;i++){
		    		html += "<div class='list_div mar-top2 '>" +
		    				"<a href='http://10.56.65.100/file/upImg/workTable/"+data.list[i].file_name+"' target='_blank'  >"+
