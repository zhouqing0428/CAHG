 ...
 <div id="main">
    ...
    <div class="cen-div color mar-t">
      <div class="con_title_left fl_left">
		...
		<a href='index/page.do'  target="_parent">首页</a>&nbsp;>&nbsp;<a href='dept/dept_left.do'  target="_parent">制度建设</a>&nbsp;>&nbsp;办事处工作
		</div>   
      </div>
...
function getDataList(){
	...
	$('.page').createPage(function(curPage){
		$.ajax({
		    url:"dept/officeWorkFileList.do?office_work_category_id="+office_work_category_id,
		    dataType : "json", 
		    method:"post",
		    async: true,  
