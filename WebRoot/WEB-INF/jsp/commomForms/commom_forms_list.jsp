 ...
 <div id="main">
    ...
    <div class="cen-div color mar-t">
      <div class="con_title_left fl_left">
		...
		<a href='index/page.do'  target="_parent">首页</a>&nbsp;>&nbsp;常用表格列表
		</div>   
      </div>
...
<script>
	...
	$('.page').createPage(function(curPage){
		$.ajax({
		    url:"commomForm/commomFormsList.do",
		    dataType : "json", 
		    method:"post",
		    async: true,  
		    	...
		    	var html = "";
		     	for(var i=0;i<data.list.length;i++){
		    		html += "<div class='list_div mar-top2 '>" +
		    				"<a href='http://10.56.65.100/file/upImg/commonforms/"+data.list[i].file_name+"' target='_blank'  >"+
		    				"  <div class='list-right_title fon_1'><b>"+data.list[i].file_old_name+"</b></div>" +
		    				...
		    				"<td width='50%' align='right' ><span class='column-name'><b>作者："+data.list[i].file_old_name+"</b></span></td>"+
		    				"</tr></table></a></div>";
		    	}
		     	$("#list").html(html);
		    }
